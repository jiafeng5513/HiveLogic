...
def get_tool_registry():
    ...
    from src.agent.tools.code_tools import ALL_CODE_TOOLS
    from src.agent.tools.vision_tools import ALL_VISION_TOOLS

    registry = ToolRegistry()
    for tool_fn in ALL_DATA_TOOLS + ALL_ANALYSIS_TOOLS + ALL_SEARCH_TOOLS + ALL_MARKET_TOOLS + ALL_BACKTEST_TOOLS + ALL_CODE_TOOLS + ALL_VISION_TOOLS:
